				...
				<div className="max-w-screen-lg m-auto p-4 flex items-start grow gap-3 w-full">
					...
					<aside className="w-full max-w-sm bg-white rounded-md shadow-sm p-3 flex flex-col gap-2">
						...
						<p className="text-sm text-zinc-500">
							[event-description]: Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam aliquid asperiores beatae
							deserunt dicta dolorem eius eos fuga laborum nisi officia pariatur quidem repellendus, reprehenderit sapiente, sed
